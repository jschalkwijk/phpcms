	...
	<div class="row">
		<div class="col-sm-6 col-md-6 col-sm-offset-3 col-md-offset-3">
			<form method="post" action="<?= ADMIN.'contacts/info/'.$contact->getID().'/'.$contact->getFirstName(); ?>">
				...
				<?php } ?>
				<button type="button"><?= '<a href="'.ADMIN.'contacts/edit-contact/'.$contact->getID().'/'.$contact->getFirstName().'">Edit</a>'?></button>
			</form>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6 col-md-6 col-sm-offset-3 col-md-offset-3">
			...
			<table>
				...
				<tr>
					<td>Number</td>
					<td><?= $contact->getStreetNum(); ?></td
				</tr>
				<tr>
					<td>Addition</td>
					<td><?= $contact->getStreetNumAdd(); ?></td>
				</tr>
				<tr>
					<td>ZIP/Postal</td>
					<td><?= $contact->getZip(); ?></td
				</tr>
				<tr>
