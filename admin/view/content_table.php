...
if ($_SESSION['rights'] == 'Admin' || $_SESSION['rights'] == 'Content Manager') { ?>
		<td class="td-btn"><a href="<?php echo $single->getDbt().'/edit-'.$single->getDbt().'/' .$single->getID().'/' .$single->getTitle() ?>"><img class="glyph-small link-btn" src="<?php echo IMG_UPLOADPATH.'edit.png';?>"/></a></td>
