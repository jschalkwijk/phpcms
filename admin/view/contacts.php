            ...
            <div class="center">
                ...
                <form class="backend-form" method="post" action="<?= $action; ?>">
                    <table class="backend-table title">
                        <tbody>
                        <tr>
                            <th>Name</th><th>Surname</th><th>Phone</th><th>E-mail</th><th>Edit</th><th><button id="check-all"><img class="glyph-small" src="<?= IMG."check.png";?>" alt="check-unchek-all-items"/></button></th>
                        </tr>
                    <?php foreach($data['contacts'] as $contact){?>
                        <tr>
                            ...
                            <td class="td-btn"><p><input type="checkbox" name="checkbox[]" value="<?= $contact->getID(); ?>"/></p></td>
                        </tr>
                    <?php } ?>
                        </tbody>
                    </table>
