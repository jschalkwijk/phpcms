...
<?php if($this->basket->itemCount()) { ?>
    <div class="container">
        ...
        <table class="backend-table title">
            <tr><th>Product</th><th>€ p/item</th><th>Quantity</th><th>€ Total</th><th><button type="button" id="check-all"><img class="glyph-small" src="<?php echo IMG."check.png"; ?>" alt="check-unheck-all-items"/></button></th></tr>
