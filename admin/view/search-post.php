<?php
	...
	if(isset($_POST['search-post'])){
		...
		foreach ($keywords as $term) {
			$term = trim($term);
			if (!empty($term)) {
				$keyword_query[] = "title LIKE '%$term%' OR content LIKE '%$term%'";
			}
		}
