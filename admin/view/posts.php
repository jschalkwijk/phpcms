<div class="container">
	...
	<form class="backend-form" method="post" action="<?php echo $action; ?>">
		<table class="backend-table title">
			<tr><th>Title</th><th>Author</th><th>Category</th><th>Date</th><th>Edit</th><th>View</th><th><button type="button" id="check-all"><img class="glyph-small" alt="check-all-items" src="/admin/images/check.png"/></button></th></tr>
			<?php
