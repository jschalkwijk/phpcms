<table>
	<?php if($data['trashed'] === 0){ ?>
		...
		<tr>
			<td><p><button type="submit" name="trash-selected" id="trash-selected"><img class="glyph-small" alt="trash-selected" src="<?= IMG.'trash-post.png'?>"/></button></p></td>
	...
	<?php } else if($data['trashed'] === 1){ ?>
		...
		<tr>
			<td><p><button type="submit" name="restore-selected" id="restore-selected"><img class="glyph-small" alt="restore-selected-from-trash" src="<?= IMG.'add-post.png'?>"/></button></p></td>
