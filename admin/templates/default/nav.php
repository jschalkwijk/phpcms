<nav>
	<ul>
		...
		<li><a href="/cms/admin">Dashboard</a></li>
		<li><a href="/cms/admin/posts">Posts</a></li>
		<li><a href="/cms/admin/pages">Pages</a></li>
		<li><a href="/cms/admin/file">Files</a></li>
		<li><a href="/cms/admin/contacts">Contacts</a></li>
		<?php if($_SESSION['rights'] == 'Admin') { ?> <li><a href="/cms/admin/users">Users</a></li> <?php } ?>
		<!--
<li><a href="/admin/downloads">Downloads</a></li>
		<li><a href="/admin/projects">Projects</a></li>
-->
		<li><a href="/cms/admin/products">Products</a></li>
		<li><a href="/cms/admin/cart"><?php echo "Cart(".$this->basket->itemCount().")"; ?> </a></li>
		<?php
		...
		?>
		<li><a href="/cms/admin/search"><img class="glyph-medium" alt="search" src="images/search-1.png"/></a></li>
