<nav>
	<ul>
		...
		<li><a href="/admin/file">Files</a></li>
		<li><a href="/admin/contacts">Contacts</a></li>
		<?php if($_SESSION['rights'] == 'Admin') { ?> <li><a href="/admin/users">Users</a></li> <?php } ?>
		<!--
<li><a href="/admin/downloads">Downloads</a></li>
		<li><a href="/admin/projects">Projects</a></li>
-->
		<li><a href="/admin/products">Products</a></li>
		<li><a href="/admin/cart"><?php echo "Cart(".$this->itemCount.")"; ?> </a></li>
		<?php
