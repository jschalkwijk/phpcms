...
function rsMenu() {
	...
	var wordpress = nav.getElementsByTagName('div')[0];;
	var menu = document.createElement("div");
	var img = document.createElement("img");
	img.id = "show"; 	img.src = "http://jornschalkwijk.nl/wp-content/themes/portfolio/menu-white.png";
	menu.id = "menu"; 	
	...
	wordpress.insertBefore(menu, ul);
